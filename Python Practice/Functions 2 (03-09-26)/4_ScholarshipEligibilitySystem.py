...
marks = [int(x) for x in input(f"Enter marks of {n} students: ").split()]

eligible = list(filter(lambda x:x>=75,marks))

bonus = list(map(lambda x:x+5,eligible))

print(*sorted(bonus,reverse=True))
